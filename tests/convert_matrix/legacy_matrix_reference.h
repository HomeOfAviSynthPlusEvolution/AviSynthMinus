...
// Frozen pre-cleanup coefficient oracle for public pixel tests only.
// Never included by production code or linked into AvsCore.
namespace avsut::test::legacy_matrix_reference {
