...
// Pure ARM policy mapping, also testable from non-ARM hosts. Apple Highway
// NEON_BF16 code requires I8MM in addition to dot product permission.
int64_t AvsArmFlagsToHighwayMask(int64_t avs_cpu_flags, bool apple);

// Converts raw AviSynth CPU flags (e.g. from IScriptEnvironment::GetCPUFlagsEx())
